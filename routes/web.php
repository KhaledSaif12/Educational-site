...
Route::group(['middleware'=>'auth'], function () {
    ...
    Route::post('/save_cate', [CategoryControllr::class, 'store'])->name('save_cate')->middleware('role:super_admin');
    Route::get('/admin/categories/edit/{id}', [CategoryControllr::class, 'edit'])->name('edit_category')->middleware('role:super_admin');
    Route::put('/admin/categories/update/{id}', [CategoryControllr::class, 'update'])->name('update_category')->middleware('role:super_admin');
    Route::delete('/admin/categories/{id}', [CategoryControllr::class, 'destroy'])->name('delete_category')->middleware('role:super_admin');
    ...
    Route::get('/admin/articles/edit/{id}', [ArticleController::class, 'edit'])->name('edit_article')->middleware('role:super_admin');
    Route::post('/admin/articles/update/{id}', [ArticleController::class, 'update'])->name('update_article')->middleware('role:super_admin');
    Route::delete('/admin/articles/{id}', [ArticleController::class, 'destroy'])->name('delete_article')->middleware('role:super_admin');
    Route::get('/add_articles',[ArticleController::class,'create'])->name('add_articles')->middleware('role:super_admin');
    Route::post('/save_article',[ArticleController::class,'store'])->name('save_article')->middleware('role:super_admin');
    Route::get('/list_article',[ArticleController::class,'index'])->name('list_article');
    Route::get('/show_article/{id}',[ArticleController::class,'show'])->name('show_article')->middleware('role:super_admin');
